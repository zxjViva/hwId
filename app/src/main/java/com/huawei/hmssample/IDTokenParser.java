...
public class IDTokenParser {
     ...
     */
    public void verify(String idToken, final ICallBack callBack) throws InvalidPublicKeyException {
        ...
        getRSAPublicKeyByKidAsyn(decoder.getKeyId(), new ICallBack() {
            ...
            public void onSuccess() {
                try {
                    ...
                    JSONObject jsonObject = new JSONObject(new String(Base64.decode(decoder.getPayload(),
                            Base64.URL_SAFE), Charset.forName("UTF-8")));
